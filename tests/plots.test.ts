...
import { createPlot, updatePlot, runPlot, plotAlgorithm } from "../src/plotFunctions";
...
//         plotAlgorithm(arr, "selectionSort"); //2.
//         // Not working
//         expect(selectionSort).toHaveBeenCalledWith(arr, true, expect.any(Array));
//         // Not working
